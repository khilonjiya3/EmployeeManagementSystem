...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: const TextStyle(
        ...
        color: AppColors.secondary900, letterSpacing: -0.2,
      ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.secondary200)),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.secondary200)),
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.primary500, width: 1.5)),
      errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.error500)),
      focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.error500, width: 1.5)),
      labelStyle: const TextStyle(fontFamily: 'Inter', color: AppColors.secondary500, fontSize: 14),
      hintStyle: const TextStyle(fontFamily: 'Inter', color: AppColors.secondary400, fontSize: 14),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: AppColors.primary500, foregroundColor: AppColors.white,
        elevation: 0, minimumSize: const Size(double.infinity, 52),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        textStyle: const TextStyle(fontFamily: 'Inter', fontSize: 15, fontWeight: FontWeight.w600, letterSpacing: 0.1),
      ),
    ),
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: AppColors.primary500, side: const BorderSide(color: AppColors.primary500),
    ...
    dividerTheme: const DividerThemeData(color: AppColors.secondary100, thickness: 1, space: 1),
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      ...
      backgroundColor: AppColors.white, elevation: 8,
  ...
  static final darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      seedColor: AppColors.primary500, brightness: Brightness.dark,
      primary: AppColors.primary400, secondary: AppColors.secondary400,
      surface: AppColors.cardDark, error: AppColors.error500,
    ),
    fontFamily: 'Inter',
    scaffoldBackgroundColor: AppColors.backgroundDark,
    appBarTheme: AppBarTheme(
      backgroundColor: AppColors.surfaceDark, elevation: 0, scrolledUnderElevation: 1,
      titleTextStyle: const TextStyle(fontFamily: 'Inter', fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.white, letterSpacing: -0.2),
    ...
    cardTheme: CardThemeData(
      ...
      color: AppColors.cardDark, surfaceTintColor: Colors.transparent,
    ),
    textTheme: const TextTheme(
  ...
  static final pinkPurpleTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      seedColor: AppColors.purple500, brightness: Brightness.light,
      primary: AppColors.purple500, secondary: AppColors.pink500,
      surface: AppColors.pinkPurpleSurface, error: AppColors.error500,
    ),
    fontFamily: 'Inter',
    scaffoldBackgroundColor: AppColors.pinkPurpleBackground,
    appBarTheme: AppBarTheme(
      backgroundColor: AppColors.pinkPurpleSurface, elevation: 0, scrolledUnderElevation: 1,
      shadowColor: AppColors.pink100, centerTitle: false,
      titleTextStyle: const TextStyle(fontFamily: 'Inter', fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.purple900, letterSpacing: -0.2),
      iconTheme: const IconThemeData(color: AppColors.purple600, size: 22),
    ),
    cardTheme: CardThemeData(
      elevation: 0,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12), side: const BorderSide(color: AppColors.pink200)),
      color: AppColors.white, surfaceTintColor: Colors.transparent, margin: EdgeInsets.zero,
    ),
    inputDecorationTheme: InputDecorationTheme(
      filled: true, fillColor: AppColors.pink50,
      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.pink200)),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.pink200)),
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.purple500, width: 1.5)),
      errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.error500)),
      focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.error500, width: 1.5)),
      labelStyle: const TextStyle(fontFamily: 'Inter', color: AppColors.purple400, fontSize: 14),
      hintStyle: const TextStyle(fontFamily: 'Inter', color: AppColors.pink300, fontSize: 14),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: AppColors.purple500, foregroundColor: AppColors.white,
        elevation: 0, minimumSize: const Size(double.infinity, 52),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        textStyle: const TextStyle(fontFamily: 'Inter', fontSize: 15, fontWeight: FontWeight.w600, letterSpacing: 0.1),
      ),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: AppColors.purple500, side: const BorderSide(color: AppColors.purple500),
        minimumSize: const Size(double.infinity, 52),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        textStyle: const TextStyle(fontFamily: 'Inter', fontSize: 15, fontWeight: FontWeight.w600),
      ),
    ...
    chipTheme: ChipThemeData(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      side: BorderSide.none, backgroundColor: AppColors.pink100, selectedColor: AppColors.purple100,
      labelStyle: const TextStyle(fontFamily: 'Inter', fontSize: 12, fontWeight: FontWeight.w500),
    ),
    dividerTheme: const DividerThemeData(color: AppColors.pink100, thickness: 1, space: 1),
    listTileTheme: const ListTileThemeData(contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 4)),
    textTheme: const TextTheme(
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      type: BottomNavigationBarType.fixed,
      selectedItemColor: AppColors.purple500, unselectedItemColor: AppColors.pink300,
      backgroundColor: AppColors.white, elevation: 8,
      selectedLabelStyle: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w600),
      unselectedLabelStyle: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w400),
    ),
